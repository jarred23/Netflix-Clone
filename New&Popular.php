...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/new&popular.css" />
  ...
  <body>
    ...
    <!-- banner -->
    <header id="bannerNew">
      <div id="banner__contentsNew">
        <h1 id="banner__titleNew"></h1>
        <div id="banner__buttons">
          <button id="banner__button">Play</button>
          <button id="banner__button">My List</button>
        </div>
        <p id="banner__descriptionNew"></p>
      </div>
      <div id="banner__fadeBottomNew"></div>
    </header>

    <!-- row -->
    <div id="headrowNew">
      <div class="rowNew">
        <h2 class="row__titleNew"></h2>
        <div class="row__postersNew"></div>
      </div>
    </div>
