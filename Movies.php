...
<html lang="en">
  ...
  <body>
    ...
    <!-- banner -->
    <header id="bannerMovies">
      <div id="banner__contentsMovies">
        <h1 id="banner__titleMovies"></h1>
        <div id="banner__buttons">
          <button id="banner__button">Play</button>
          <button id="banner__button">My List</button>
        </div>
        <p id="banner__descriptionMovies"></p>
      </div>
      <div id="banner__fadeBottomMovies"></div>
    </header>

    <!-- row -->
    <div id="headrowMovies">
      <div class="rowMovies">
        <h2 class="row__titleMovies"></h2>
        <div class="row__postersMovies"></div>
      </div>
    </div>
